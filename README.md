...
This branch uses VirtualBox which is the cross platform implementation. For a macOS / OS X specific implementation using Veertu, please checkout the [veertu](/kitchen-docker-host-vagrant/tree/veertu) branch.
